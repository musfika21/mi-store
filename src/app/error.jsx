...
export default function FloralError({
    title = "Oops! Something Went Wrong",
    message = "It seems like something unexpected happened in our garden. Don't worry, our gardeners are working to fix this issue. Please try again in a moment.",
    showRefresh = true,
    showHome = true,
    showGoBack = true,
    showContact = false,
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#F8F6FF] via-[#FDF2F8] to-[#FEF7ED] dark:from-[#1F1B29] dark:via-[#2D1B36] dark:to-[#3A2545] flex items-center justify-center p-4">
            <div className="w-full max-w-4xl mx-auto text-center space-y-8">
                ...
                <Card className="border-0 shadow-2xl bg-white/70 dark:bg-[#2D1B36]/70 backdrop-blur-xl p-8 md:p-12 rounded-3xl">
                    ...
                    <div className="relative mb-8">
                        <div className="w-32 h-32 mx-auto mb-6 relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-[#BA96C1] to-[#9C8CB9] rounded-full opacity-20 animate-pulse"></div>
                            <div className="absolute inset-2 bg-gradient-to-r from-[#BA96C1] to-[#9C8CB9] rounded-full opacity-30 animate-pulse delay-150"></div>
                            <div className="absolute inset-4 bg-gradient-to-r from-[#BA96C1] to-[#9C8CB9] rounded-full opacity-40 animate-pulse delay-300"></div>
                            <div className="absolute inset-8 flex items-center justify-center">
                                <AlertTriangle className="w-16 h-16 text-[#4B3F6E] dark:text-[#DCD7D5]" />
                            </div>
                        </div>
                    </div>
                ...
                <p className="text-[#6C5F8D] dark:text-[#BA96C1] text-sm opacity-75">
                    "Even the most beautiful gardens need tending" - We'll have this blooming again soon
                </p>
            </div>
